...
# gen higgs dR
plotting.singleHistPlot(
    genHVV.deltaR(genHbb),
    events["weight"],
    dRbins,
    xlabel="$\Delta R$ between gen HVV and gen Hbb",
    title="Gen HH $\Delta R$",
    plotdir=plotdir,
    name="genHiggsdR",
)

# leading VV to gen HVV matching
plotting.multiHistCutsPlot(
    genHVV.deltaR(VVLeadingFatJet),
    ...
    title="AK15 VV FatJet Gen Matching",
    plotdir=plotdir,
    name="VVgenmatching",
    ylim=1.5,
)
...
plotting.multiHistCutsPlot(
    ...
    title="AK8 bb FatJet Gen Matching",
    plotdir=plotdir,
    name="bbgenmatching",
    ylim=1.5,
)
...
plotting.multiHistCutsPlot(
    ...
    title="AK15 VV FatJet Candidate Gen Matching",
    plotdir=plotdir,
    name="VVcandgenmatching",
    ylim=1.5,
)

# bb dR with leading and candidate VV
plotting.multiHistPlot(
    [bbLeadingFatJet.deltaR(VVLeadingFatJet), bbLeadingFatJet.deltaR(VVCandFatJet)],
    weights=events["weight"],
    bins=dRbins,
    labels=["VV Leading FatJet", "VV Candidate FatJet"],
