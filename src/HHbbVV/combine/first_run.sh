...
combine -M FitDiagnostics -d ${wsm_snapshot}.root --setParameters mask_passCat1=1,mask_fail=1,mask_passCat1Blinded=0,mask_failBlinded=0 --saveNormalizations --saveShapes --saveWithUncertainties --saveOverallShapes -n Blinded --ignoreCovWarning --skipSBFit -v 9 --snapshotName MultiDimFit --freezeParameters CMS_bbWW_boosted_ggf_qcdparam_msdbin5,CMS_bbWW_boosted_ggf_qcdparam_msdbin6,CMS_bbWW_boosted_ggf_qcdparam_msdbin7,CMS_bbWW_boosted_ggf_qcdparam_msdbin8,CMS_bbWW_boosted_ggf_qcdparam_msdbin9,r,rgx{fail_ggHH_kl_1_kt_1_hbbhww4q_mcstat_bin.*},rgx{failBlinded_ggHH_kl_1_kt_1_hbbhww4q_mcstat_bin.*},rgx{passCat1_ggHH_kl_1_kt_1_hbbhww4q_mcstat_bin.*},rgx{passCat1Blinded_ggHH_kl_1_kt_1_hbbhww4q_mcstat_bin.*},rgx{passCat1_ttbar_mcstat_bin.*},rgx{fail_ttbar_mcstat_bin.*}
