...
Jobs:
```
python3 src/condor/submit.py --processor input --tag $TAG --files-per-job 10 --samples QCD --label AK15_QCD --njets 1 --maxchunks 1 --subsamples QCD_Pt_300to470 QCD_Pt_470to600 QCD_Pt_600to800 QCD_Pt_800to1000 QCD_Pt_1000to1400
...
python3 src/condor/submit.py --processor input --tag $TAG --files-per-job 2 --samples HWWPrivate --subsamples jhu_HHbbWW GluGluToHHTo4V_node_cHHH1 --label AK15_H_VV --njets 2
